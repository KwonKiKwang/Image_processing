...
Original file is located at
    https://colab.research.google.com/drive/1igPlaAtJ-NTAlv7g1oIyQgOhpyHphLWS
"""
...
def test_measure_BRISQUE(imgPath):
    ...
    # load model 
    model = svmutil.svm_load_model("/gdrive/MyDrive/allmodel.py")  #allmodel 파일이 저장된 경로 지정
...
test_measure_BRISQUE('/gdrive/MyDrive/DXA_Image/Femur/Femur 22.jpg')
# 스코어링 하고자하는 이미지 경로를 입력

test_measure_BRISQUE('/gdrive/MyDrive/IQA/LR50.png')

test_measure_BRISQUE('/gdrive/MyDrive/IQA/SR50.png')

test_measure_BRISQUE('/gdrive/MyDrive/IQA/BI50.png')

test_measure_BRISQUE('/gdrive/MyDrive/IQA/LR100.png')

test_measure_BRISQUE('/gdrive/MyDrive/IQA/SR100.png')

test_measure_BRISQUE('/gdrive/MyDrive/IQA/BI100.png')

test_measure_BRISQUE('/gdrive/MyDrive/IQA/LR150.png')

test_measure_BRISQUE('/gdrive/MyDrive/IQA/SR150.png')

test_measure_BRISQUE('/gdrive/MyDrive/IQA/BI150.png')

test_measure_BRISQUE('/gdrive/MyDrive/Low.png')

test_measure_BRISQUE('/gdrive/MyDrive/High.png')

test_measure_BRISQUE('/gdrive/MyDrive/Original Image.jpg')

test_measure_BRISQUE('/gdrive/MyDrive/Super Resolution.jpg')

test_measure_BRISQUE('/gdrive/MyDrive/Lr.png')

test_measure_BRISQUE('/gdrive/MyDrive/Sr.png')